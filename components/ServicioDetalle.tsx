...
const productosDelivery: Record<string, { nombre: string; nombreVisible?: string; imagen: string; unidad: string; href?: string; detalle?: string }[]> = {
  'Tortas': [
    ...
    { nombre: 'Torta de Lúcuma', imagen: imagenes['Torta de Lúcuma'], unidad: 'un',
      detalle: 'Bizcocho de vainilla, crema de lúcuma y manjar, decorada con rosetones y toques de caramelo' },
