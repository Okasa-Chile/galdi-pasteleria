...
export const imagenes: Record<string, string> = {
  ...
  'Arma tu Torta':             '/images/torta-personalizada.webp',
  // Dulces & Alfajores
...
const categorias = [
  ...
  },
  {
    ...
    productos: [
      ...
      { nombre: 'Arma tu Torta',      detalle: 'Diseña tu torta ideal: elige base, relleno, decoración y tamaño. Elaborada artesanalmente por encargo.', href: '/arma-tu-torta' },
    ],
  },
  {
    id: 'dulces',
