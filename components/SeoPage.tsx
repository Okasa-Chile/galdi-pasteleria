  ...
  return (
    <main style={{ background: 'var(--cream)', minHeight: '100vh', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ position: 'relative', height: 'clamp(220px, 30vh, 320px)', overflow: 'hidden' }}>
        <Image src={imagen} alt={titulo} fill style={{ objectFit: 'cover', objectPosition: 'center 30%' }} />
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 5%' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', justifyContent: 'center', marginBottom: '3rem' }}>
          <a href={ctaHref} style={{ background: 'var(--terracota)', color: 'var(--cream)', padding: '1rem 2.5rem', fontFamily: 'var(--font-sans)', fontSize: '0.85rem', letterSpacing: '0.15em', textTransform: 'uppercase', textDecoration: 'none', border: '1px solid var(--terracota)' }}>
            {ctaTexto}
          </a>
